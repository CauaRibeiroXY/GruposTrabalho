...
//</editor-fold>
    ...
    public List<Pessoa> findPessoasPR() {
        return entityManager.createNamedQuery("Pessoa.findPessoasPR",Pessoa.class).getResultList();
    }

    @Override
    public List<Pessoa> findPessoasRJ() {
        return entityManager.createNamedQuery("Pessoa.findPessoasRJ",Pessoa.class).getResultList();
    }
    //</editor-fold>
    ...
    public List<MembroDto> findMembroDto(LocalDate dataInicio) {
        String query = "SELECT new ifnmg.edu.com.br.grupostrabalho.MembroDto(a.grupo.nome, a.inicio, a.pessoa.nome) FROM Atuacao a WHERE a.inicio >= :dataInicio";
